...
results[["BB_FASY_small"]] <- acf_autocorr_by_tree_year(models$model.bb.fasy.small, model_dataset_podrost$BB_FASY_smallTrees)
results[["BB_PCAB_small"]] <- acf_autocorr_by_tree_year(models$model.bb.pcab.small, model_dataset_podrost$BB_PCAB_smallTrees)

results[["EU_PCAB_small"]] <- acf_autocorr_by_tree_year(models$model.eu.pcab.small, model_dataset_podrost$EU_PCAB_smallTrees)

results[["RN_ACCA_small"]] <- acf_autocorr_by_tree_year(models$model.rn.acca.small, model_dataset_podrost$RN_ACCA_smallTrees)
results[["RN_CABE_small"]] <- acf_autocorr_by_tree_year(models$model.rn.cabe.small, model_dataset_podrost$RN_CABE_smallTrees)
results[["RN_ULSP_small"]] <- acf_autocorr_by_tree_year(models$model.rn.ulsp.small, model_dataset_podrost$RN_ULSP_smallTrees)

results[["ZF_FASY_small"]] <- acf_autocorr_by_tree_year(models$model.zf.fasy.small, model_dataset_podrost$ZF_FASY_smallTrees)
results[["ZF_PCAB_small"]] <- acf_autocorr_by_tree_year(models$model.zf.pcab.small, model_dataset_podrost$ZF_PCAB_smallTrees)

ouptut_autocorrel <- data.frame(Site = c(rep("Boubin",2),"Eustaska",rep("Ranspurk",3),rep("Zofin",2)),
                                Species = c("FASY", "PCAB", "PCAB", "ACCA", "CABE", "ULSP", "FASY", "PCAB"),
                                Size = rep("small", times = 8),
                                mean = c(results$BB_FASY_small$summary["Mean"],
                                         results$BB_PCAB_small$summary["Mean"],
                                         
                                         results$EU_PCAB_small$summary["Mean"],
                                         
                                         results$RN_ACCA_small$summary["Mean"],
                                         results$RN_CABE_small$summary["Mean"],
                                         results$RN_ULSP_small$summary["Mean"],
                                         
                                         results$ZF_FASY_small$summary["Mean"],
                                         results$ZF_PCAB_small$summary["Mean"]),
                                
                                above_tresh = c(results$BB_FASY_small$prop_above_threshold,
                                                results$BB_PCAB_small$prop_above_threshold,
                                                
                                                results$EU_PCAB_small$prop_above_threshold,
                                                
                                                results$RN_ACCA_small$prop_above_threshold,
                                                results$RN_CABE_small$prop_above_threshold,
                                                results$RN_ULSP_small$prop_above_threshold,
                                                
                                                results$ZF_FASY_small$prop_above_threshold,
                                                results$ZF_PCAB_small$prop_above_threshold))
